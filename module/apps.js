...
let apps = {
    ...
    photopea:{
        ...
        load: () => {
            $('#win-photopea')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://www.photopea.com/" frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>');
        }
    },
    defender: {
        init: () => {
